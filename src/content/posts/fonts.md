...
| 中文字体                                        | 英文字体                                         | 备注           |
| ----------------------------------------------- | ------------------------------------------------ | -------------- |
| 苹方                                            | TESLA <i class="fa-solid fa-lock"></i>           | 非商用，仅自用 |
| 思源                                            | Bebas-Neue                                       |                |
| 霞鹜文楷                                        | Quicksand                                        |                |
| 萌神                                            | Montserrat                                       |                |
| 方正楷体                                        | DingTalk Sans                                    |                |
| 张清平楷书、行书                                | JetBrainsMono                                    |                |
| 锐字真言体                                      | ComicNeue                                        |                |
| 钉钉进步体                                      | KesawanScript                                    |                |
| 旁门正道粗书体                                  | FreeStyleScript <i class="fa-solid fa-lock"></i> | 非商用，仅自用 |
| 资源圆体                                        | UnifrakturMaguntia                               |                |
| 得意黑                                          | Playball                                         |                |
| HarmonyOS Sans                                  | GreatVibes                                       |                |
| Mi Sans <i class="fa-solid fa-circle-info"></i> |                                                  | 注意小字条款   |
| Oppo Sans                                       |                                                  |                |
